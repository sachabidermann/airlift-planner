...
const expected = {
  nc216859: { gateway: "KSJC", delivered: 4836 },
  ak20419010: { gateway: "PANC", delivered: 4693 },
  ci38457511: { gateway: "KMHV", delivered: 2053 },
  us70006vll: { gateway: "TJSJ", delivered: 4399 },
  usp000h60h: { gateway: "MTPP", delivered: 3131 },
  us20002926: { gateway: "VNKT", delivered: 4547 },
  us6000jllz: { gateway: "LTAJ", delivered: 4706 },
  us7000kufc: { gateway: "GMMX", delivered: 4949 },
  us7000pn9s: { gateway: "VYHH", delivered: 1905 },
  gllegacyhaywiredm7p05_se: { gateway: "KSFO", delivered: 4833 },
  sclegacyshakeout2full_se: { gateway: "KLGB", delivered: 4810 },
  gllegacycasc9p0expanded_se: { gateway: "KTCM", delivered: 1545 },
  wa22sfz01_se: { gateway: "KNUW", delivered: 2020 },
  nm19fema_m7p7_mt_se: { gateway: "KMEM", delivered: 4777 },
  caribe25puertorico_2_se: { gateway: "TJSJ", delivered: 3226 },
};
...
for (const ev of data.events) {
  ...
  if (exp) {
    checked++;
    const ok = exp.gateway === gw && Math.abs(exp.delivered - d) <= 2;
